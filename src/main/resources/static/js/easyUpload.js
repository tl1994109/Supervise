    ...
    this.each(function (index, element) {
      ...
      var easyManager = {
        init: function () {
          ...
          $html += option.showNote ? '<span class="easy_upload_note" style="margin-left: 20px">' + option.note + '</span>' : '';
          $html += '</div>';
