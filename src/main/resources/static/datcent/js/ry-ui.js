    ...
    $.extend({
        ...
        table: {
            ...
            dropdownToggle: function (value) {
                ...
                actions.push('<b>处置方式</b>&nbsp;<span class="fa fa-chevron-down"></span></button>');
                actions.push('<ul class="dropdown-menus" style="display: none">');
            ...
            importTemplate: function() {
                $.table.set();
                $.get(initSimpleTabl._options.importTemplateUrl, function(result) {
                    if (result.code == web_status.SUCCESS) {
        ...
        operate: {
            ...
            detailFull: function (id) {
                ...
                $.modal.openFull($.table._option.modalName + "详细", _url);
            },
            // 删除信息
            remove: function (id) {
            ...
            save: function (url, data,type,callback) {
                ...
                var config = {
                    ...
                    success: function (result) {
                        if(type == '2'){
                            $.operate.saveSuccessNotReload(result);
                            callback();
                        }else{
            ...
            saveSuccessNotReload:function(result){
                if (result.code == web_status.SUCCESS) {
