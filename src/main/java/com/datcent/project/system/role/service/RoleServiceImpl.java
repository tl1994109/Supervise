package com.datcent.project.system.role.service;
...
import com.datcent.project.system.role.domain.RoleDept;
import com.datcent.project.system.role.domain.RoleMenu;
import com.datcent.project.system.role.mapper.RoleDeptMapper;
import com.datcent.project.system.role.mapper.RoleMapper;
import com.datcent.project.system.role.mapper.RoleMenuMapper;
...
public class RoleServiceImpl implements IRoleService
{
    ...
    public int deleteRoleByIds(String ids) throws Exception
    {
        ...
        for (Long roleId : roleIds)
        {
            ...
            if (roleId==1 || roleId==100 || roleId==2 || roleId ==110 || roleId==111 || roleId==113)
            {
                throw new Exception(String.format("默认角色不可删除", role.getRoleName()));
            }
        }
