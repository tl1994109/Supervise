...
public class UserController extends BaseController
{
    ...
    public TableDataInfo list(User user)
    {
        ...
        List<User> list = userService.selectUserList(user,pageDomain);
    ...
    {
        List<User> list = userService.selectUserList(user,new PageDomain());
    ...
    public String add(ModelMap mmap)
    {
        ...
        mmap.put("person", personService.selectPersonAll());
        return prefix + "/add";
    }
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap)
    {
        ...
        mmap.put("person", personService.selectPersonList(new Person(),new PageDomain()));
        return prefix + "/edit";
    }
