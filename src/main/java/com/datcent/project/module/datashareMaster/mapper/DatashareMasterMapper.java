package com.datcent.project.module.datashareMaster.mapper;
 ...
 * @date 2019-05-27
 */
public interface DatashareMasterMapper 
{
	/**
     * 查询各法院数据权限信息
     * 
     ...
     * @return 结果
     */
	public int deleteDatashareMasterById(Integer datashareId);
	
	/**
     * 批量删除各法院数据权限
     * 
     * @param datashareIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteDatashareMasterByIds(String[] datashareIds);
