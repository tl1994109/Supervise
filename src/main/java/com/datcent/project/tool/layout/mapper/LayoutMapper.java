package com.datcent.project.tool.layout.mapper;
...
public interface LayoutMapper 
{
     ...
     * @return 结果
     */
	public int deleteLayoutById(String layoutId);
	
	/**
     * 批量删除布局管理
     * 
     * @param layoutIds 需要删除的数据ID
     * @return 结果
     */
	public int deleteLayoutByIds(String[] layoutIds);
