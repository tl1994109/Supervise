package com.datcent.common.constant;
...
public class UserConstants
{
    ...
    /** 法院名称是否唯一的返回结果码 */
    public final static String COURT_NAME_UNIQUE = "0";
    public final static String COURT_NAME_NOT_UNIQUE = "1";
    ...
    /** 流程名称是否唯一的返回结果码 */
    public final static String PROCESS_UNIQUE = "0";
    public final static String PROCESS_NOT_UNIQUE = "1";
